...
git init && git add . && git commit -m "Commit inicial" && git branch -M main && git remote add origin https://github.com/marcio-dev-fullstack/Folha-de-Ponto.git && git push -u origin main
